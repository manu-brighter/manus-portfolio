 ...
 * VP9 webm via MediaRecorder + downloads it.
 *
 * HISTORICAL NOTE: this originally produced `public/ambient-loop.mp4`
 * for the AmbientVideo tablet fallback. That path was retired in the
 * mobile wow-pass (all coarse-pointer devices run the live
 * MobileBackgroundSim; the mp4 was deleted). The recorder stays as a
 * general dev capture tool — e.g. for social/OG clips of the sim.
 * MediaRecorder outputs webm; transcode to H.264 mp4 if a target
 * needs it (iOS Safari plays VP9 mp4 as a still).
 *
 ...
 *      `ambient-loop-Ns.webm`. If a target needs H.264 mp4:
 ...
 *          -c:v libx264 -crf 30 -movflags +faststart out-loop.mp4
 *
